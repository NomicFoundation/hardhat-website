...
When your script connects to Hardhat Network and involves transactions, you can use the `--verbosity` (or `-v`) flag to show call traces. For example, `-vvv` shows traces for failing transactions:
