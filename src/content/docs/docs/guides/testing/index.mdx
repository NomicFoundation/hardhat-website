...
Hardhat 3 includes built-in support for [code coverage](/docs/guides/testing/code-coverage), [gas statistics](/docs/guides/testing/gas-statistics), and debugging with [call traces](/docs/explanations/global-options#verbosity). These features are available to both Solidity and TypeScript tests.
