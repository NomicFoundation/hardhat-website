...
If you configured multiple Test Profiles, use the `--test-profile` option to choose which one to run with:

<Run command="hardhat test solidity --test-profile ci" />

To learn more about running your tests with different settings, read the [Test Profiles guide](/docs/guides/testing/test-profiles).
