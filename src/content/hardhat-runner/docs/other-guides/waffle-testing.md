...
```
npm install --save-dev chai@4 @nomiclabs/hardhat-waffle@hh2
```
...
```
npm install --save-dev chai@4 @nomiclabs/hardhat-waffle@hh2 ethereum-waffle @nomiclabs/hardhat-ethers@hh2 ethers@5
```
...
```
yarn add --dev chai@4 @nomiclabs/hardhat-waffle@hh2 ethereum-waffle @nomiclabs/hardhat-ethers@hh2 ethers@5
```
