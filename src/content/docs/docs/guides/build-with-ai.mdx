...
<RunRemote command="skills add https://github.com/NomicFoundation/hardhat/tree/main/packages/hardhat/skills --skill hardhat" />
...
<RunRemote command="skills add https://github.com/NomicFoundation/hardhat/tree/main/packages/hardhat/skills --skill hardhat-toolbox-viem" />

If your project is based on [`hardhat-toolbox-mocha-ethers`](/docs/plugins/hardhat-toolbox-mocha-ethers):

<RunRemote command="skills add https://github.com/NomicFoundation/hardhat/tree/main/packages/hardhat/skills --skill hardhat-toolbox-mocha-ethers" />
