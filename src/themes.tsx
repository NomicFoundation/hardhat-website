...
export const lightPalette = {
  ...
  backButton: "#6E6F70",
  copyButtonText: "#4B4D4D",
  copyButtonBackground: "#F2F2F2",
  copyButtonBorder: "#C4C4C4",
  copyButtonHoverBackground: "#E5E6E7",
  copyButtonTextDark: "#F2F2F2",
  copyButtonBackgroundDark: "#282C34",
  copyButtonBorderDark: "#6C6F74",
  copyButtonHoverBackgroundDark: "#20232A",
