...
| **Performance**           | Lazy-loaded on demand       | Loaded with config           |
| **File organization**     | Separate action files       | Defined inline               |
| **Best for**              | Reusable, complex logic     | Quick, simple tasks          |
